...
CREATE TABLE IF NOT EXISTS `enrollments` (
  ...
  `preferred_date` DATE DEFAULT NULL COMMENT 'Candidate preferred exam date (Saturday or Sunday)',
  `preferred_time_slot` VARCHAR(50) DEFAULT NULL COMMENT 'Candidate preferred time slot (e.g. 10:00:00-11:00:00)',
